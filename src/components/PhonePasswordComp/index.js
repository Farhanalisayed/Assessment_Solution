...
class PhonePasswordComp extends Component {
  ...
  onInputFaqs = event => {
    ...
    if (theValue === '') {
      ...
      const marshaledObject = textMarshal({
        input: theValue,
    ...
    return (
      <div className="group-container">
        <div className="mobile-container">
          <label htmlFor="isd-mobile" className="label">
            Mobile Number <span className="required">*</span>
          </label>
          <div id="isd-mobile" className="isd-mobile-container">
            {this.renderISD()}
